      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-display font-bold">TerraPulse</span>
            </Link>
            <p className="text-neutral-300 mb-6 max-w-md">
              AI-powered real estate intelligence platform providing accurate property 
              price predictions, ROI analysis, and market insights for the Indian real estate market.
            </p>
          ...
          <div className="max-w-md">
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
        ...
        <div className="py-6 border-t border-neutral-800 flex flex-col sm:flex-row justify-between items-center">
          <div className="text-sm text-neutral-400 mb-4 sm:mb-0">
            © {currentYear} TerraPulse. All rights reserved.
          </div>
